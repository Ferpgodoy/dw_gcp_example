...
CREATE OR REPLACE EXTERNAL TABLE raw.candidate_social_media
OPTIONS (
  format = 'CSV',
  uris = ['gs://projeto_1_dw_raw/eleicoes/rede_social_candidato/{year}/*.csv'],
  skip_leading_rows = 1,
  field_delimiter = ';',
...
-- Check if the table bronze.candidate_social_media exists
